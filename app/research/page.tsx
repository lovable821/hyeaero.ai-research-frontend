  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 mb-6">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">Ask Consultant (AI Chat)</h2>
...
function MarketComparisonTab() {
  return (
    <div className="max-w-6xl mx-auto">
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 mb-6">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">Market Comparison</h2>
        <p className="text-gray-600 mb-6">
        ...
        <div className="border border-gray-200 rounded-lg p-6 bg-gray-50 min-h-[400px] flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500">Market Comparison Tool Coming Soon</p>
            <p className="text-sm text-gray-400 mt-2">
...
function PriceEstimatorTab() {
  return (
    <div className="max-w-4xl mx-auto">
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 mb-6">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">Price Estimator</h2>
        <p className="text-gray-600 mb-6">
        ...
        <div className="border border-gray-200 rounded-lg p-6 bg-gray-50 min-h-[400px] flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500">Price Estimator Tool Coming Soon</p>
            <p className="text-sm text-gray-400 mt-2">
...
function ResaleAdvisoryTab() {
  return (
    <div className="max-w-4xl mx-auto">
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 mb-6">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">Resale Advisory</h2>
        <p className="text-gray-600 mb-6">
        ...
        <div className="border border-gray-200 rounded-lg p-6 bg-gray-50 min-h-[400px] flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500">Resale Advisory Service Coming Soon</p>
            <p className="text-sm text-gray-400 mt-2">
