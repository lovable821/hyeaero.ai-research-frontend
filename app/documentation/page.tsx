    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="bg-gradient-to-r from-primary-50 to-accent-50 py-12 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Documentation</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 bg-gray-50 rounded-lg p-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/research" className="text-primary-600 hover:text-primary-700 font-medium">
                Research Tools →
              </Link>
              <Link href="/market-data" className="text-primary-600 hover:text-primary-700 font-medium">
                Market Data →
              </Link>
